...
namespace Tools.DataAccess.Migrations
{
    ...
    [Migration("20230117145749_OrderIni")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Tools.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Tools.Models.OrderDetail", b =>
                {
                    b.HasOne("Tools.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Tools.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Tools.Models.OrderHeader", b =>
                {
                    b.HasOne("Tools.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Tools.Models.ApplicationUser", b =>
                {
                    b.HasOne("Tools.Models.Company", "Company")
                        .WithMany()
